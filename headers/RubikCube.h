...
class RubikCube
{
	private:
		...
		void indexCheck(const unsigned int& index);
	...
	public:
		...
		void turnUp(unsigned side, unsigned index);
		void turnDown(unsigned side, unsigned index);
		void turnLeft(unsigned side, unsigned index);
		void turnRight(unsigned side, unsigned index);
};
#endif